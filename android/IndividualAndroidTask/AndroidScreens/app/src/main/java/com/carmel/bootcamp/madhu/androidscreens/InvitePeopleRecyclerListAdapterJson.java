...
class InvitePeopleRecyclerListAdapterJson extends RecyclerView.Adapter<InvitePeopleRecyclerListAdapterJson.MyViewHolder> {
    private Context context;
    JSONObject datalist;
    public InvitePeopleRecyclerListAdapterJson(Context context, JSONObject object) {
...
//                profileDescription.setText(object.getString("description"));
